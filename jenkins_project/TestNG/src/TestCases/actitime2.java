	...
	public class actitime2 {
		...
		public void setup(String browser) throws MalformedURLException {
			...
			if(browser.equalsIgnoreCase("iexplore")){
				...
				//System.setProperty("webdriver.ie.driver", "F:\\WorkSpace\\Sellinium\\IEDriverServer.exe");
		...
		public void login () throws InterruptedException, MalformedURLException {
			...
			driver1.findElement(By.xpath("//input[@id='username']")).sendKeys("user");
			driver1.findElement(By.xpath("//input[@name='pwd']")).sendKeys("user");
